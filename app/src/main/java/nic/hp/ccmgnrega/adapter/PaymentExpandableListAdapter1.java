...
public class PaymentExpandableListAdapter1 extends BaseExpandableListAdapter {

    private Context context;
    private List<String> applicantIdList;
    private List<List<String>> workCodeList;
    private HashMap<String, HashMap<String,List<PaymentInfo>>> applicantIdToWorkCodeToPaymentMapping;
    private int textSize = 14;
    private String languageCode;

    public PaymentExpandableListAdapter1(Context context,
                                         List<String> applicantIdList,
                                         List<List<String>> workCodeList,
                                         HashMap<String, HashMap<String,List<PaymentInfo>>> applicantIdToWorkCodeToPaymentMapping,
                                         String languageCode) {
        this.context = context;
        this.applicantIdList = applicantIdList;
        this.workCodeList = workCodeList;
        this.applicantIdToWorkCodeToPaymentMapping = applicantIdToWorkCodeToPaymentMapping;
...
//            workCodeList.add("No Payments");
//        }

        List<List<PaymentInfo>> payments = new ArrayList<>();
        HashMap<String,List<PaymentInfo>> workCodeToPaymentMapping = applicantIdToWorkCodeToPaymentMapping.get(applicantIdList.get(lstPosn));

        for (String workCode : workCodeList) {
            payments.add(workCodeToPaymentMapping.get(workCode));
        }
        ...
        secondLevelExpandableListView.setAdapter(new PaymentExpandableListAdapter2(context, workCodeList, payments, languageCode, lstPosn));
    ...
    public View getGroupView(int listPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        Pair<String,String> listTitles = PaymentTabData.getFirstLevelApplicantDetail(applicantId);
