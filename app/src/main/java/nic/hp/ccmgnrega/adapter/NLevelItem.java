...
import nic.hp.ccmgnrega.adapter.interfaces.NLevelListItem;
import nic.hp.ccmgnrega.adapter.interfaces.NLevelView;
...
public class NLevelItem implements NLevelListItem {
    ...
    public NLevelItem(Object wrappedObject, NLevelItem parent,
                      NLevelView nLevelView) {
